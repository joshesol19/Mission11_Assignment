...
const AdminBooksPage = ({ selectedCategories }: {selectedCategories: string[]}) => {
    ...
    <>
      <div className="container py-4">
        <WelcomeBanner />
        <h1 className="mb-3">Admin View</h1>
            ...
            <div className="col-md-6 col-lg-4" key={b.bookID}>
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <br />
                  <button className="btn btn-sm btn-primary me-2" onClick={() => navigate(`/add-to-cart/${b.bookID}`)}>Add to Cart</button>
                  <button className="btn btn-sm btn-outline-secondary me-2" onClick={() => navigate(`/edit-book/${b.bookID}`)}>Edit</button>
                  <button className="btn btn-sm btn-outline-danger" onClick={() => navigate(`/delete-book/${b.bookID}`)}>Delete</button>
                </div>
              </div>
            </div>
          ))}
